...
- icon (string; required): The icon to show, e.g. 'fa-globe' from "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
...
- n_clicks (number; default 0): Dash callback property. Number of times the object has been clicked"""
    ...
    def __init__(self, children=None, icon=Component.REQUIRED, className=Component.UNDEFINED, id=Component.UNDEFINED, n_clicks=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'icon', 'className', 'id', 'n_clicks']
        self._type = 'EasyButton'
        self._namespace = 'dash_leaflet'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'icon', 'className', 'id', 'n_clicks']
